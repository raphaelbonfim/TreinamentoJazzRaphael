...
using TreinamentoJazzRaphael.Sessions;
using TreinamentoJazzRaphael.Web.Controllers.Results;
using TreinamentoJazzRaphael.Web.Models;
using TreinamentoJazzRaphael.Web.Models.Account;
...
{
    public class AccountController : TreinamentoJazzRaphaelControllerBase
    {
